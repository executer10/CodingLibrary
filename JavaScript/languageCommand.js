...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const languageElements = {
        ...
        JSP_main: [],
        Spring_main: [],
        Python_main: ["Python_Built_In_Function", "Python_Variables_And_DataTypes", "Python_DataStructuresBasics", "Python_Numpy", "Python_Pandas", "Python_graph", "Python_PublicDataUtilization"]
    };
